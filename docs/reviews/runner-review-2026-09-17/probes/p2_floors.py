...
res = [NS(case=NS(case_id="F1-1"), required={"m1": Q})]
buf = io.StringIO()
...
print("== P3 per-case losses: seven +1.0, one -1.0 (forbidden by the metric) ->", cl.state.value, round(cl.value,3), "cases", cl.cases)
